...
After loading the images we test plotting a random image with its label to be sure that we have loaded the images and labels correctly.
...
cm = confusion_matrix(y_true, y_pred, labels=label_enc.inverse_transform(knn_model.classes_))
disp = ConfusionMatrixDisplay(confusion_matrix=cm,
                              display_labels=label_enc.inverse_transform(knn_model.classes_))
disp.plot()
...
input_img_feature = vgg_mdl.predict(input_img)
input_img_features = input_img_feature.reshape(input_img_feature.shape[0], -1)
pred = knn_model.predict(input_img_features)[0] 
pred = label_enc.inverse_transform([pred])  # Reverse the label encoder to original name
...
print("GradientBoost Accuracy", accuracy)
print("GradientBoost F1 Score", f1score)

cm = confusion_matrix(y_true, y_pred, labels=label_enc.inverse_transform(xgboost_model.classes_))
disp = ConfusionMatrixDisplay(confusion_matrix=cm,
                              display_labels=label_enc.inverse_transform(xgboost_model.classes_))
disp.plot()
plt.xticks(rotation=90)
plt.show()
...
input_img_feature = vgg_mdl.predict(input_img)
input_img_features = input_img_feature.reshape(input_img_feature.shape[0], -1)
pred = xgboost_model.predict(input_img_features)[0] 
pred = label_enc.inverse_transform([pred])  # Reverse the label encoder to original name
print("The prediction for this image is: ", pred)
print("The actual label for this image is: ", test_labels[n])
```
...
cm = confusion_matrix(y_true, y_pred, labels=label_enc.inverse_transform(rf_model.classes_))
disp = ConfusionMatrixDisplay(confusion_matrix=cm,
                              display_labels=label_enc.inverse_transform(rf_model.classes_))
disp.plot()
plt.xticks(rotation=90)
plt.show()
...
input_img_feature = vgg_mdl.predict(input_img)
input_img_features = input_img_feature.reshape(input_img_feature.shape[0], -1)
pred = rf_model.predict(input_img_features)[0] 
pred = label_enc.inverse_transform([pred])  # Reverse the label encoder to original name
print("The prediction for this image is: ", pred)
print("The actual label for this image is: ", test_labels[n])
```
